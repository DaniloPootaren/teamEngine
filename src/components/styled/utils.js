...
const paddingUtil = css`
  ${({ padding }) => theme.spacings[padding] && `padding: ${theme.spacings[padding]} !important;`};
  ${({ paddingVertical }) =>
  ...
  ${({ paddingLeft }) =>
    theme.spacings[paddingLeft] && `padding-left: ${theme.spacings[paddingLeft]} !important;`};
  ${({ paddingRight }) =>
    theme.spacings[paddingRight] && `padding-right: ${theme.spacings[paddingRight]} !important;`};
  ${({ paddingTop }) =>
    theme.spacings[paddingTop] && `padding-top: ${theme.spacings[paddingTop]} !important;`};
  ${({ paddingBottom }) =>
...
const marginUtil = css`
  ${({ margin }) => theme.spacings[margin] && `margin: ${theme.spacings[margin]} !important;`};
  ${({ marginVertical }) =>
  ...
  ${({ marginLeft }) =>
    theme.spacings[marginLeft] && `margin-left: ${theme.spacings[marginLeft]} !important;`};
  ${({ marginRight }) =>
    theme.spacings[marginRight] && `margin-right: ${theme.spacings[marginRight]} !important;`};
  ${({ marginTop }) =>
    theme.spacings[marginTop] && `margin-top: ${theme.spacings[marginTop]} !important;`};
  ${({ marginBottom }) =>
    theme.spacings[marginBottom] && `margin-bottom: ${theme.spacings[marginBottom]} !important;`};
...
const backgroundUtil = css`
  ${({ backgroundColor }) =>
    theme.colors[backgroundColor] && `background-color: ${theme.colors[backgroundColor]}`};
`;
...
const textUtil = css`
  ...
  ${({ textColor }) => theme.colors[textColor] && `color: ${theme.colors[textColor]} !important`}
  ${({ textSize }) =>
    theme.textSizes[textSize] && `font-size: ${theme.textSizes[textSize]} !important`}
...
const borderUtil = css`
  ${({ borderBottom }) =>
    theme.borders[borderBottom] && `border-bottom: 1px solid ${theme.borders[borderBottom]}`};
  ${({ borderTop }) =>
    theme.borders[borderTop] && `border-top: 1px solid ${theme.borders[borderTop]}`};
  ${({ borderLeft }) =>
    theme.borders[borderLeft] && `border-left: 1px solid ${theme.borders[borderLeft]}`};
  ${({ borderRight }) =>
    theme.borders[borderRight] && `border-right: 1px solid ${theme.borders[borderRight]}`};
`;
